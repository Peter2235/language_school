...
<my:pagetemplate title="Edit lecture">
    <jsp:attribute name="body">

        <form:form method="post" action="${pageContext.request.contextPath}/lecture/edit/${lectureEdit.id}"
                   modelAttribute="lectureEdit" cssClass="form-horizontal">
            ...
            <button class="btn btn-primary" type="submit">Edit Lecture</button>
        </form:form>
