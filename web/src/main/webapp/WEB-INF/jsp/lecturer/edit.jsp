...
<my:pagetemplate title="Edit lecturer">
    <jsp:attribute name="body">

        <form:form method="post" action="${pageContext.request.contextPath}/lecturer/edit/${lecturerEdit.id}"
                   modelAttribute="lecturerEdit" cssClass="form-horizontal">
            ...
            <button class="btn btn-primary" type="submit">Update Lecturer</button>
        </form:form>
